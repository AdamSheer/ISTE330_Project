...
public class Group3PL {
    ...
    private void adminMenu(String userId) {
        ...
        while (loggedIn) {
            ...
            switch (choice) {
                // If the admin chooses to add a client
                case 0:
                    // Prompt for client details
                    Group3BL.addNewClient();
                    break;
                // If the admin chooses to add an admin
                case 1:
                    // Prompt for admin details
                    Group3BL.addNewAdmin();
                    break;
                // If the admin chooses to view a table
                case 2:
    ...
    private void clientMenu(String userId) {
        ...
        while (loggedIn) {
            ...
            switch (choice) {
                case 0:
                    // If the user chooses to view their info
                    Group3BL.viewStudentInfo(userId); // Display student info
                    break;
                case 1:
                    // If the user chooses to transfer money
